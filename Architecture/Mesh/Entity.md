...
```
template<template<int> typename S, size_t D, size_t G, typename Mesh>
struct Entity
{
	private:
	...
	public:
		...
		auto get_adjency(); //return the direct neighbours (from the adjacency graphs defined in the mesh)
};
```